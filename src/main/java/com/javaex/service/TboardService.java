...
public class TboardService {
	...
	// 리스트(검색O,페이징 O)
		public Map<String, Object> exeList3(int crtPage,String keyword) {
			...
			List<TboardVo> boardList = tboardDao.boardSelectList3(limiMap);
	...
	public Map<String, Object> exeList2(int crtPage) {
		...
		// starRowNo, listCnt Map으로 묶는다
		Map<String, Integer> limiMap = new HashMap<String, Integer>();
		limiMap.put("startRowNo", startRowNo);
		limiMap.put("listCnt", listCnt);

		// dao에 전달해서 현재페이지의 리스트 10개를 받는다
		List<TboardVo> boardList = tboardDao.boardSelectList2(limiMap);
