				...
				<div id="user">
					<div id="modifyForm">
						<form action="${pageContext.request.contextPath}/user/modify" method="get">
							...
							<!-- 아이디 -->
								<input type="hidden" id="input-pass" name="no" value="${userVo.no}" placeholder="비밀번호를 입력하세요"	>
							<div class="form-group">
								<label class="form-text" for="input-uid">아이디</label> 
								<input type="hidden" id="input-pass" name="id" value="${userVo.id}" placeholder="아이디를 입력하세요"	>
